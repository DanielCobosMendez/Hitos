...
from Utiles.Esquemas import Cauchy, Euler, RK2, RK4, EulerI, CrankNicolson, LeapFrog
...
U_LF = Cauchy(Funcion, dt, U0, LeapFrog, T, N)
...
plt.plot(U_LF[:,0], U_LF[:,1], label = 'LeapFrog')
...
plt.plot(U_LF[:,2], U_LF[:,3], label = 'LeapFrog')
plt.title('Comparación de métodos numéricos')
...
plt.plot(linspace(0, T, N), U_LF[:,0], label = 'LeapFrog')
...
plt.plot(linspace(0, T, N), U_LF[:,1], label = 'LeapFrog')
...
plt.plot(linspace(0, T, N), U_LF[:,2], label = 'LeapFrog')
...
plt.plot(linspace(0, T, N), U_LF[:,3], label = 'LeapFrog')
